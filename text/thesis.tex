...
% All regressions use Newey–West standard errors to make them more robust. The number of lags is equal to the closes integer of the fourth root of the number of observations (726), which is 5.  % & fist-difference ($X_t-X_{t-1}$)
