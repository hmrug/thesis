...
# Figure 4: Debt in 2020
f_4, ax = plt.subplots(1,1,figsize=[15,6])
ax.xaxis.set_major_locator(mdates.MonthLocator(interval=3))
ax.xaxis.set_major_formatter(mdates.DateFormatter("%b %Y"))
ax.set_xlim(dtt(2019,1,1),dtt(2021,12,30))
ax.set_ylim(16,23)
ax.plot(df["DEBT"],c='k', label="_nolegend_",lw=3)
# ax.axvspan(dtt(2020,4,1),dtt(2021,4,1), alpha=0.4, color='gray')
ax.set_title("Total outstanding public debt of the US")
ax.text(0,0,"Treasury deluge")
ax.text(0.5,0.5,"Treasury scarcity")
sns.despine()
plt.tight_layout()
f_4.savefig(fig_path+"debt-2020.pdf")
